(function() {
  ...
  function buildQuiz() {
    ...
    JavaScriptQuestions.forEach((currentQuestion, questionNumber) => {
      const answers = [];
  ...
  function showResults() {
    ...
    if (correct == 1) {
      resultsContainer.innerHTML = `You correctly answered ${correct} question out of ${JavaScriptQuestions.length} questions!`;
    } else if (correct == 0) {
      resultsContainer.innerHTML = `You have no correct answers!`;
    } else {
      resultsContainer.innerHTML = `You correctly answered ${correct} questions out of ${JavaScriptQuestions.length} questions!`;
    }
